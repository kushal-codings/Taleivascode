...
client.on("ready", async () => {
  console.log(`ready!`);
  client.user
    .setActivity(`Servers : ${await client.guilds.cache.size} | Users : ${await client.users.cache.size} | s?help`, { type: "PLAYING" })
...
fetch('https://alabaster-palm-chatter.glitch.me')
